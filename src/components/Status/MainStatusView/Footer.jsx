...
import likedImg from "../../../assets/liked.png"; // import liked image
import "./Footer.css"; // we'll put animation styles here
...
const Footer = ({ statusId }) => {
  ...
  useEffect(() => {
    if (statusId) {
      console.log("📩 Footer received statusId:", statusId);
    }
  }, [statusId]);
